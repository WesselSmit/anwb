// NOTE: this logic has been separated into its file to illustrate that the matrixes could easily be managed elsewhere if needed (e.g. managed by editors in a CMS, types can be generated using a tool like Swagger) or it can be it's own JS/TS/JSON file in the codebase (like it is now).
